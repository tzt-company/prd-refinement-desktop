...
const project={id:'P-ILCD-V2',name:'ILCD合规字段调整-过程管理',sourceName:path.basename(source),sourceHash:createHash('sha256').update(rawText).digest('hex'),revision:1,importedAt:new Date().toISOString(),rawText,stage:'imported',sourceUnits:[],rules:[],features:[],requirements:[],clarifications:[]};
